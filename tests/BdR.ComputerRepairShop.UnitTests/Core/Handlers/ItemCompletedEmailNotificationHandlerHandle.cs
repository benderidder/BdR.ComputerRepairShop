...
using BdR.ComputerRepairShop.Core.ProjectAggregate.Events;
using BdR.ComputerRepairShop.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace BdR.ComputerRepairShop.UnitTests.Core.Handlers;
